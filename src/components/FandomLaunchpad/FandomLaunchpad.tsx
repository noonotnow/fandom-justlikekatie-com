  ...
  return (
    <main className={styles.launchpad}>
      <header className={styles.header}>
        ...
        <p className={styles.intro}>Fandom Vibes is a creative home for the worlds we love. We’re launching with Vibe Atlas: one C-drama star, one assigned vibe, and nine collectible pieces of evidence every day.</p>
      ...
      <footer><span>FANDOM VIBES / VIBE ATLAS IS LIVE</span><span><a href="/c-drama-fandom/">C-drama fandom</a> · More universes remain in the studio.</span></footer>
    </main>
  );
}
