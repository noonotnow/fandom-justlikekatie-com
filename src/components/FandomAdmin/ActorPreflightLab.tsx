...
export const ActorPreflightLab: React.FC = () => {
  ...
  async function downloadCalibrationExport() {
    ...
    try {
      ...
      setNotice('Read-only retained calibration evidence and joined publication receipts downloaded. No audit was rerun or changed.');
    } catch(e:any) { setNotice(e.message); } finally { setBusy(''); }
  }
...
function RunEvidence({
  run,currentRun,priorRuns,selectedReadOnly,busy,disagreementReasons,editorialNote,onChoice,onReasonChange,onNoteChange,onSaveReasons,onFlag,onVisualJudgment,onSaveRescue,onExportRescue,onMarkCalibration,onRetireCalibration,onSelect,initialReceiptId,
}:{
