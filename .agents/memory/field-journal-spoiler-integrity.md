...
**How to apply:** Enforce these rules server-side in every future public page, share artifact, veteran-submission flow, export, or alternate client. Client-side hiding is supplementary, never the spoiler boundary.