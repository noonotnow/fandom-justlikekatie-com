---
name: Legendary Misprint scope
description: Product boundary for preserving one-off system bloopers without reopening cross-universe or filter contamination.
---

Legendary Misprint is attached to one member-preserved event, not to an entire universe. It may capture a cross-universe collision (such as a Vibe Atlas grid containing Gandalf) or a same-universe filter/event anomaly (such as the Dylan Wangtermelon event).
