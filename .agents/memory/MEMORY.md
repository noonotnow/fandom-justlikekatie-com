...
- [Disclosure state in history-switch tests](disclosure-state-history-switch.md) — React can preserve an open details element across record switches; collapse it before testing closed-summary behavior.
